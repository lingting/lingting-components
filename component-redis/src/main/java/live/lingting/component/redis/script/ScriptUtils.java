 ...
 *
 * @see org.springframework.data.redis.core.script.ScriptUtils
 * @author Mark Paluch
...
class ScriptUtils {
	...
	/**
	 * Deserialize {@code result} using {@link RedisSerializer} to the serializer type.
	 * Collection types and intermediate collection elements are deserialized recursivly.
	...
	/**
	 * Deserialize {@code result} using {@link RedisElementReader} to the reader type.
	 * Collection types and intermediate collection elements are deserialized recursively.
	...
	/**
	 * Checks whether given {@link Throwable} contains a {@code NOSCRIPT} error.
	 * {@code NOSCRIPT} is reported if a script was attempted to execute using
	 * {@code EVALSHA}.
	 * @param e the exception.
	 * @return {@literal true} if the exception or one of its causes contains a
	 * {@literal NOSCRIPT} error.
	 */
